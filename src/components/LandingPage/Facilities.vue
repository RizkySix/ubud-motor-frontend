<template>
  ...
  >
    ...
    <div
      class="my-0 mx-[!important] absolute top-[450px] left-[520px] flex flex-col items-center justify-end gap-[8px] z-[2]"
    >
      <img
    ...
    <div
      class="my-0 mx-[!important] absolute top-[50px] left-[520px] flex flex-col items-center justify-end gap-[8px] z-[3]"
    >
      <img
        class="relative rounded-23xl w-[400px] h-[360px] object-cover z-[0]"
        alt=""
    ...
    <div
      class="my-0 mx-[!important] absolute top-[50px] left-[960px] flex flex-col items-center justify-end gap-[8px] z-[4] text-center"
    >
      <img
        class="relative rounded-23xl w-[400px] h-[360px] object-cover z-[0]"
        alt=""
    ...
    <div
      class="my-0 mx-[!important] absolute top-[450px] left-[960px] flex flex-col items-center justify-end gap-[8px] z-[5]"
    >
      <img
        class="relative rounded-23xl w-[400px] h-[360px] object-cover z-[0]"
        alt=""
