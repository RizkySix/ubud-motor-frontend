           ...
           <div class="w-full hidden lg:block">
                <div class="rounded-lg shadow-lg px-4 py-6 bg-slate-200 mt-5 border border-dashed">
                    ...
                    <p class="text-gray-500">
                            For information on <span class="font-bold">units availability</span> or other information regarding motorbike rental, please contact us. Oh ya, we will only accept motorbike <span class="font-bold">delivery for bookings over 5 days, around the Ubud and Canggu areas.</span>
                    </p>

                    <a href="https://wa.me/082145597640" target="_blank" class="flex gap-4 mt-4">
                        ...
                        <div class="flex flex-col text-gray-500">
                            <span class="font-bold text-2xl">0821-4559-7640</span>
